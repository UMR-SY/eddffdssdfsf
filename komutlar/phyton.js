...
exports.run = function(client, message) {
  ...
  message.channel.send(`✅ Phyton Rolü Başarıyla Verildi NOT: JavaScript 2 Adlı Rolü Almak İçin 1 İnvite Yapman Lazım Yaptıktan Sonra Otomatik Olarak Verilecektir! `);
};
